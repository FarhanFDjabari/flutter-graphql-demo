...
mixin _$CountryModel {
  ...
  List<LanguagesModel> get languages => throw _privateConstructorUsedError;
...
class _$_CountryModel implements _CountryModel {
  const _$_CountryModel(
      ...
      required this.emoji,
      this.currency,
      required final List<LanguagesModel> languages,
  ...
  final List<LanguagesModel> _languages;
  @override
  List<LanguagesModel> get languages {
  ...
  @override
  String toString() {
    return 'CountryModel(code: $code, name: $name, capital: $capital, emoji: $emoji, currency: $currency, languages: $languages, continent: $continent)';
  }
...
abstract class _CountryModel implements CountryModel {
  const factory _CountryModel(
      ...
      final String? currency,
      required final List<LanguagesModel> languages,
      required final ContinentModel continent}) = _$_CountryModel;
